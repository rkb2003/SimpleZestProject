...
public class SimpleZestViewer {
   ...
   String filePath = "C:/Users/Rajasree/eclipse-workspace/Plug-in-Project-1023/Plug-in-Project-1023/input-data-zest-1023.txt";


   public SimpleZestViewer() {
   }
   ...
   void createGraphNode() {
      ...
      for (String iName : listNodeNames) {
         ...
         this.mapGraphNode.put(iName, new GraphNode(graph, SWT.NONE, iName) );
      }
   ...
   */
      ...
      for (String[] iConn : readConnectionInfo) {
         ...
         new GraphConnection(graph, SWT.NONE,this.mapGraphNode.get(iConn[0]) ,this.mapGraphNode.get(iConn[1]) );
      }
